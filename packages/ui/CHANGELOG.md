...
- 67c74aa: Fixed icon size into IconButton
...
- 7ec92ab: Refactored Icon component to accept icon objects directly from `@adara-cs/icons` instead of using the `name` prop. Also added support for passing custom icons.
