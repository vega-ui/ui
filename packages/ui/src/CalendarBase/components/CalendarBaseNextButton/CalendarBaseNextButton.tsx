...
export type CalendarBaseNextButtonProps = IconButtonProps

/**
 * `CalendarBaseNextButton` is the foundational “next” navigation button
 ...
 */
export const CalendarBaseNextButton: FC<CalendarBaseNextButtonProps> = ({ children, ...props }) => {
