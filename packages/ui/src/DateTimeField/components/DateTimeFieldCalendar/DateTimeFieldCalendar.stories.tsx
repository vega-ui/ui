...
import { DateTimeFieldCalendar } from './DateTimeFieldCalendar';
...
const meta = {
  title: 'Form/Fields/DateField/DateTimeFieldCalendar',
  component: DateTimeFieldCalendar,
...
} satisfies Meta<typeof DateTimeFieldCalendar>;
