...
export {
  ...
  DialogBackdrop, type DialogBackdropProps,
  DialogPortal, type DialogPortalProps,
  DialogTitle, type DialogTitleProps,
  DialogCloseButton, type DialogCloseButtonProps,
} from './components'
